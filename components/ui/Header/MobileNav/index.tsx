...
const MobileNav = (props: MobileNavProps) => {
	...
	return (
		<>
			...
			>
				<span
					className={`bg-plitz-accent block transition-all duration-300 ease-out 
			...
			<div
				className={`${
					isOpen ? 'fixed' : 'hidden'
				} ${opacity} bg-plitz-bgs opacity-95 left-0 top-[66px] h-[calc(100vh-66px)] w-screen p-20 z-40 transition-all duration-200`}
			>
				<nav>
